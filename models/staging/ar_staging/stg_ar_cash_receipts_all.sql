...
with source as (
  select * from {{ source('ar_raw', 'raw_ar_cash_receipts_all') }}
),
...
cleaned as (
  ...
  select
    ...
    factor_discount_amount::number       as factor_discount_amount,
    ...
    org_id,
    anticipated_clearing_date::date     as anticipated_clearing_date,
    global_attribute1,
    global_attribute2,
    global_attribute3,
    global_attribute4,
    ...
    actual_value_date::date            as actual_value_date,
    postmark_date::date                as postmark_date,
    application_notes,
    unique_reference,
    promise_source,
    rec_version_number,
    ...
    cash_appln_owner_id,
    work_item_assignment_date::timestamp_ntz as work_item_assignment_at,
    work_item_review_date::timestamp_ntz    as work_item_review_at,
